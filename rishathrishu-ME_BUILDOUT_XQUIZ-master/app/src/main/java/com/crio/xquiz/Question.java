...
public class Question{
    ...
    public Question(String questionText, List<String> choices, String answerText){
        if (questionText == null || questionText.isEmpty()){  // false
                System.out.println("Question text cannot be null or empty!");
        } 
        else if (choices == null || choices.isEmpty()){ // false
                System.out.println("Choices cannot be null or empty!");
        }
         else if (answerText == null || answerText.isEmpty()){ //false
                System.out.println("Answer cannot be null or empty!");
        }
        else if(!choices.contains(answerText)){ //false
